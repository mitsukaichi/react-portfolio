        ...
        <div className="container">
            <footer className="d-flex flex-wrap justify-content-around align-items-center py-3 border-top fixed-bottom">
                ...
                <li className="ms-5">
                    ...
                    <li className="ms-5">
                        <a className="text-body-secondary" href="https://www.linkedin.com/in/minami-itsukaichi/">
                    ...
                    <li className="ms-5">
                        <a className="text-body-secondary" href="https://stackoverflow.com/users/23017928/minami-itsukaichi">
